...
export default function Blog() {
  ...
  if (loading) {
    return (
      <>
        <SEO
          title="Blog | IA Atelier - Web Design, Branding & Digital Insights"
          description="Read the latest articles from IA Atelier on web design, branding, UI/UX, SEO, and digital trends to help your business grow."
          keywords="IA Atelier blog, web design blog, branding articles, UI UX blog, SEO tips, digital marketing insights"
          url="/blog"
        />
  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: "#FAFAF8" }}>
        {/* Aapka existing Blog page code yahan se start hoga */}
