...
export default function Portfolio() {
    ...
    useEffect(() => {
        const fetchProjects = async () => {
            ...
            if (error) {
                ...
                // technologies ko hamesha array banao
                const fixed = (data || []).map(proj => ({
                    ...proj,
                    technologies: Array.isArray(proj.technologies)
                        ? proj.technologies
                        : typeof proj.technologies === "string"
                            ? (() => { try { return JSON.parse(proj.technologies); } catch { return proj.technologies.split(",").map(t => t.trim()).filter(Boolean); } })()
                            : []
                }));
                setProjects(fixed);
            }
    ...
    if (loadingProjects) {
        return (
            <>
                <SEO
                    title="Portfolio | IA Atelier - Web Design & Branding Projects"
                    description="Explore IA Atelier's portfolio featuring premium web design, branding, UI/UX, and digital experience projects for businesses."
                    keywords="IA Atelier portfolio, web design portfolio, branding projects, UI UX portfolio, website design"
                    url="/portfolio"
                />
            ...
            <div style={{ backgroundColor: "#FAFAF8" }}>
                <section className="pt-40 pb-20 px-6 lg:px-10 max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <span className="section-label">{p.badge}</span>
                    </motion.div>
