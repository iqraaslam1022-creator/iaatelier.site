...
export default function Portfolio() {
  ...
  useEffect(() => {
    // Disable horizontal scroll animation in RTL mode to prevent crash
    if (lang === "ar") {
      return;
    }
  ...
  // For Arabic mode, show grid-proj cards immediately (no scroll animation)
  useEffect(() => {
    if (lang === "ar") {
  ...
  return (
    <div style={{ backgroundColor: "#FAFAF8" }}>
      ...
      {/* Horizontal scroll section - only show in English (LTR) */}
      {lang === "en" && (
      ...
      {/* CTA section for Arabic mode (replaces horizontal scroll) */}
      {lang === "ar" && (
