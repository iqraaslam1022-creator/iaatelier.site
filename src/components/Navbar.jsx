              ...
              {NAV_ITEMS.map((item) => {
                ...
                return (
                  <Link
                    key={item.path}
                    to={item.path}
                    className={`relative px-4 py-2 text-[0.7rem] tracking-[0.18em] uppercase font-medium transition-colors duration-300 min-h-[44px] flex items-center ${
        ...
        {mobileOpen && (
          ...
          >
              ...
              {NAV_ITEMS.map((item, i) => {
                ...
                return (
                  ...
                  >
                    <Link
                      to={item.path}
                      className={`flex items-center justify-between py-4 border-b border-[#1A1A1A]/08 font-display text-2xl tracking-wide transition-colors ${
                        active ? "text-[#B8972E]" : "text-[#1A1A1A] hover:text-[#B8972E]"
                      }`}
                    >
                      <span>
            ...
            >
              <Link
                to="/contact"
                className="btn-gold rounded-sm w-full block text-center py-4"
              >
