  ...
  en: {
    ...
    about: {
      ...
      timeline: [
        ...
        { year: "2024", title: "Moving Forward", desc: "Continuing to refine our craft and deliver premium digital experiences for every client." },
      ],
      stats: [
        { value: "50+", label: "Projects Delivered" },
        { value: "3+", label: "Years Experience" },
  ...
  ar: {
    ...
    about: {
      ...
      timeline: [
        ...
        { year: "2024", title: "المضي قدماً", desc: "نواصل صقل حرفيتنا وتقديم تجارب رقمية متميزة لكل عميل." },
      ],
      stats: [
        { value: "50+", label: "مشروع منجز" },
        { value: "3+", label: "سنوات خبرة" },
